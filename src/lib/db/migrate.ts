...
import {
  ...
  CREATE_PATTERN_HISTORY_INDEX,
  CREATE_STRATEGIES,
  CREATE_WATCHLIST,
  CREATE_TRADE_PARTIAL_CLOSES,
  CREATE_TRADE_PARTIAL_CLOSES_INDEX,
  CREATE_JOURNAL_ENTRIES,
  CREATE_JOURNAL_ENTRIES_INDEX,
  CREATE_ALERT_SUBSCRIPTIONS,
  CREATE_ALERTS,
  CREATE_ALERTS_PENDING_INDEX,
